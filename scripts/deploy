...
docker run -dit --name potic-pocket-api -e POCKET_APP_KEY=$POCKET_APP_KEY -e ENVIRONMENT_NAME=$ENVIRONMENT_NAME -p 40403:5000 potic/potic-pocket-api:$TAG_TO_DEPLOY
